...
public class ListFragmentA extends Fragment {
    ...
    // короткий тычок, адаптер добавляет вювер и позицию на которую тыкался
    final private AdapterView.OnItemClickListener mOnClickListener
            = new AdapterView.OnItemClickListener() {

        public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
            //вызов метода, который потом переоределяется
            onListItemClick((ListView)parent, v, position, id);
        }
    };
    //длинное нажати, адаптер добавляет вювер и позицию на которую тыкался
   ...
   //
        ...
        mList.setOnTouchListener(new AdapterView.OnTouchListener(){
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                return onTouchA(v, event);
             }
        });
//        mList.setOnDragListener(new AdapterView.OnDragListener(){
//
//            @Override
//            public boolean onDrag(View v, DragEvent event) {
//                return  onDragA(v,event);
//            }
//        });

//        mList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){//.OnItemLongClickListener()
//
//                    public boolean onItemLongClick(AdapterView<?> parent, View v, int position, long id) {
//                        return onListItemLongClick((ListView)parent, v, position, id);
//                    }
