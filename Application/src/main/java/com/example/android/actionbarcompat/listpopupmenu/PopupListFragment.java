...
//        });
    ...
    public void initList() {
        ...
        //в значение true, что заставит адаптер обновлять список
        // после каждого добавления нового элемента.Теперь нет нужды использовать
        // метод notifyDataSetChanged(), а новые элементы будем добавлять непосредственно в адаптер
