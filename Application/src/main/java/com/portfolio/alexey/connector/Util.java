...
//    }
    ...
    //----------------------------------------------------------------------------
//    Звук и вибрация // https://developer.android.com/about/versions/android-5.0.html?hl=ru
//    Если в настоящее время вы добавляете звуки и вибрацию в уведомления с помощью классов Ringtone,
// MediaPlayer или Vibrator, удалите этот код. Тогда система будет правильно обрабатывать уведомления
// с учетом приоритета. Чтобы добавить звуки и вибрацию, используйте методы Notification.Builder.
//
//    Чтобы войти в новый режим приоритета, выберите на устройстве настройку RINGER_MODE_SILENT.
// При выборе настроек RINGER_MODE_NORMAL или RINGER_MODE_VIBRATE режим приоритета отключается.
//
//    Раньше в системе Android для управления звуком на планшетах использовался основной поток STREAM_MUSIC.
// В Android 5.0 STREAM_RING и STREAM_NOTIFICATION будут поддерживаться как для телефонов,
// так и для планшетов
